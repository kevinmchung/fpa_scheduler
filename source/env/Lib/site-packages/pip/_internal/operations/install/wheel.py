...
def message_about_scripts_not_on_PATH(scripts):
    ...
    """Determine if any js are not on PATH and format a warning.
    Returns a warning message if one or more js are not on PATH,
    otherwise None.
    """
    if not scripts:
        return None

    # Group js by the path they were installed in
...
def install_unpacked_wheel(
    ...
    :param warn_script_location: Whether to check that js are installed
    ...
    try:
        ...
        raise InstallationError(
            ...
            "specifications/entry-points/#use-for-js for more "
